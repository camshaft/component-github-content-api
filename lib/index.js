...
var GitHub = require('component-remotes').github;
...
GitHub.extend(GitHubContentAPI);

/**
 * Horrible hack to keep this thing afloat
 */
...
GitHubContentAPI.prototype.forEach = function() {
  // WTF are you doing component
};
...
GitHubContentAPI.prototype.getHash = function* (repo, ref) {
  return null;
};
...
GitHubContentAPI.prototype.request = function* (uri, opts) {
  if (~uri.indexOf('raw.github')
      || ~uri.indexOf('/tarball')
      || ~uri.indexOf('/zipball')) return yield* (this._gh_request || main._gh_request)(uri, opts);
  ...
  var res = yield* (this._gh_request || main._gh_request)(uri, opts);
